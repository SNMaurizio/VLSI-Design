...
C {lab_wire.sym} 70 -40 0 0 {name=l6 sig_type=std_logic lab=B}
C {lab_wire.sym} 350 80 2 0 {name=l7 sig_type=std_logic lab=AB}
C {lab_wire.sym} 560 -70 2 0 {name=l8 sig_type=std_logic lab=B}
C {lab_wire.sym} 350 -40 2 0 {name=l9 sig_type=std_logic lab=BB}
C {lab_wire.sym} 350 190 2 0 {name=l10 sig_type=std_logic lab=BB}
...
C {lab_wire.sym} 350 -140 2 0 {name=l16 sig_type=std_logic lab=A}
C {lab_wire.sym} 70 80 0 0 {name=l17 sig_type=std_logic lab=A}
C {lab_wire.sym} 910 -90 2 0 {name=l18 sig_type=std_logic lab=BB}
C {lab_wire.sym} 70 -140 0 0 {name=l19 sig_type=std_logic lab=AB}
C {lab_wire.sym} 70 190 0 0 {name=l20 sig_type=std_logic lab=B}
